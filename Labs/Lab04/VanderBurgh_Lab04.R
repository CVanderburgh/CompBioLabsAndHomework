...
#8b 
# 1. use read.csv() to force import everthing but the year as type numeric
mydata_1 <- read.csv("CO2_data_cut_paste.csv", stringsAsFactors = FALSE, colClasses = c("integer", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"))
str(mydata_1)
